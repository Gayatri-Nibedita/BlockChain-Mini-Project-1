...
class Block:
    ...
    # Block class includes a mineBlock(difficulty) function
    def mineBlock(self, difficulty):
        print("Mining block:")
        target = '0' * difficulty  # Set Difficulty ie; hash start with zeros
        start = time.time()
...
# Run mining
difficulty = 4  # Difficulty increased to 4 ie; hash start with "0000"
